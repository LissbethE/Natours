...
///////////////////////////////////
// A middleware to protect the tours router
...
//////////////////////////////////
// Restrict Certain Routes. for example: Deleting tours
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2) If token hasn't expired. and there is an user, set the new password
  if (!user) return next(new AppError('Token is invalid or has expired', 400));

  // We send the password and also passwordConfirm via the body
